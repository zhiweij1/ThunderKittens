...
static inline void reduce(typename SV::dtype &dst_accum, const SV &src, const typename SV::dtype &src_accum) {
    using T = SV::dtype;
...
static inline void max(typename SV::dtype &max_val, const SV &src) {
    reduce<base_ops::max, SV, true>(max_val, src, max_val);
}
template<ducks::sv::all SV>
static inline typename SV::dtype max(const SV &src) {
 ...
 */
template<ducks::sv::all SV>
static inline void min(typename SV::dtype &min_val, const SV &src) {
    reduce<base_ops::min, SV, true>(min_val, src, min_val);
}
template<ducks::sv::all SV>
static inline typename SV::dtype min(const SV &src) {
 ...
 */
template<ducks::sv::all SV>
static inline void sum(typename SV::dtype &sum_val, const SV &src) {
    reduce<base_ops::sum, SV, true>(sum_val, src, sum_val);
}
template<ducks::sv::all SV>
static inline typename SV::dtype sum(const SV &src) {
 ...
 */
template<ducks::sv::all SV>
static inline void prod(typename SV::dtype &prod_val, const SV &src) {
    reduce<base_ops::mul, SV, true>(prod_val, src, prod_val);
}
template<ducks::sv::all SV>
static inline typename SV::dtype prod(const SV &src) {
 ...
 */
template<ducks::sv::all SV>
static inline void max(typename SV::dtype &max_val, const SV &src, const typename SV::dtype &src_accum) {
    reduce<base_ops::max, SV, false>(max_val, src, src_accum);
}
template<ducks::sv::all SV>
static inline typename SV::dtype max(const SV &src, const typename SV::dtype &src_accum) {
    typename SV::dtype max_val;
    reduce<base_ops::max, SV, false>(max_val, src, src_accum);
    return max_val;
}
 ...
 */
template<ducks::sv::all SV>
static inline void min(typename SV::dtype &min_val, const SV &src, const typename SV::dtype &src_accum) {
    reduce<base_ops::min, SV, false>(min_val, src, src_accum);
}
template<ducks::sv::all SV>
static inline typename SV::dtype min(const SV &src, const typename SV::dtype &src_accum) {
    typename SV::dtype min_val;
    reduce<base_ops::min, SV, false>(min_val, src, src_accum);
    return min_val;
}
 ...
 */
template<ducks::sv::all SV>
static inline void sum(typename SV::dtype &sum_val, const SV &src, const typename SV::dtype &src_accum) {
    reduce<base_ops::sum, SV, false>(sum_val, src, src_accum);
}
template<ducks::sv::all SV>
static inline typename SV::dtype sum(const SV &src, const typename SV::dtype &src_accum) {
    typename SV::dtype sum_val;
    reduce<base_ops::sum, SV, false>(sum_val, src, src_accum);
    return sum_val;
}
 ...
 */
template<ducks::sv::all SV>
static inline void prod(typename SV::dtype &prod_val, const SV &src, const typename SV::dtype &src_accum) {
    reduce<base_ops::mul, SV, false>(prod_val, src, src_accum);
}
template<ducks::sv::all SV>
static inline typename SV::dtype prod(const SV &src, const typename SV::dtype &src_accum) {
    typename SV::dtype prod_val;
    reduce<base_ops::mul, SV, false>(prod_val, src, src_accum);
    return prod_val;
}
