...
#include "pyutils/pyutils.dp.hpp"
...
struct config {
    struct globals {
        ...
        dpct::dim3 grid() {
            return dpct::dim3(132);
        } // dim3(Q.batch * ((Q.depth + 3) / 4)); }
        dpct::dim3 block() { return dpct::dim3((8 + 4) * WARP_THREADS); }
    };
};
...
struct partial_template {
...
#ifdef KITTENS_TIMINGS
        /*
        DPCT1008:336: clock64 function is not defined in SYCL. This is a
    ...
    struct producer {
        static inline void setup(producer_setup_args<layout> args) {}
        static inline void load(producer_load_args<layout> args) {
...
#ifdef KITTENS_TIMINGS
            /*
            DPCT1008:337: clock64 function is not defined in SYCL. This is a
            hardware-specific feature. Consult with your hardware vendor to find
            a replacement.
            */
            else if (warpgroup::laneid() == 32 && args.iter < 24)
                args.timings[32 + args.iter] = clock64();
#endif
            warpgroup::sync(5);
        }
    };
    struct consumer {
...
#ifdef KITTENS_TIMINGS
            /*
            DPCT1008:338: clock64 function is not defined in SYCL. This is a
            hardware-specific feature. Consult with your hardware vendor to find
            a replacement.
            */
...
#ifdef KITTENS_TIMINGS
            /*
            DPCT1008:339: clock64 function is not defined in SYCL. This is a
            hardware-specific feature. Consult with your hardware vendor to find
            a replacement.
            */
        ...
        template<bool do_right_fill> static inline void internal_compute(consumer_compute_args<layout> args) {
...
#ifdef KITTENS_TIMINGS
            /*
            DPCT1008:340: clock64 function is not defined in SYCL. This is a
            hardware-specific feature. Consult with your hardware vendor to find
            a replacement.
            */
            if (group<8>::laneid() == 0 && args.iter < 24)
                args.timings[8 + args.iter] = clock64();
#endif
...
#ifdef KITTENS_TIMINGS
            /*
            DPCT1008:341: clock64 function is not defined in SYCL. This is a
            hardware-specific feature. Consult with your hardware vendor to find
            a replacement.
            */
            if (group<8>::laneid() == 0) args.timings[62] =
                clock64(); // Start of store out.
#endif
            ...
            sycl::atomic_fence(
                ...
                sycl::memory_scope::work_group); // Can't reorder across this
                                                 // boundary
            group<8>::sync(10);
...
#ifdef KITTENS_TIMINGS
            /*
            DPCT1008:342: clock64 function is not defined in SYCL. This is a
            hardware-specific feature. Consult with your hardware vendor to find
            a replacement.
            */
...
struct reduction_template {
...
#ifdef KITTENS_TIMINGS
        /*
        DPCT1008:343: clock64 function is not defined in SYCL. This is a
        hardware-specific feature. Consult with your hardware vendor to find a
        replacement.
        */
        if (group<12>::laneid() == 0) args.timings[0] = clock64();
...
#ifdef KITTENS_TIMINGS
                /*
                DPCT1008:344: clock64 function is not defined in SYCL. This is a
                hardware-specific feature. Consult with your hardware vendor to
                find a replacement.
                */
                if (laneid() == 0 && args.iter < 24)
                    args.timings[32 + args.iter] = clock64();
#endif
                // next page we need to load?
    ...
    struct consumer {
        static inline void setup(consumer_setup_args<layout> args) {
            ...
            if (sycl::ext::oneapi::this_work_item::get_nd_item<3>()
                    .get_local_id(2) ==
                0) { // easier to have a single thread spin
...
#ifdef KITTENS_TIMINGS
            /*
            DPCT1008:345: clock64 function is not defined in SYCL. This is a
            hardware-specific feature. Consult with your hardware vendor to find
            a replacement.
            */
            if (group<8>::laneid() == 0) args.timings[1] = clock64();
...
#ifdef KITTENS_TIMINGS
            /*
            DPCT1008:346: clock64 function is not defined in SYCL. This is a
            hardware-specific feature. Consult with your hardware vendor to find
            a replacement.
            */
            if (group<8>::laneid() == 0) args.timings[2] = clock64();
...
#ifdef KITTENS_TIMINGS
            /*
            DPCT1008:347: clock64 function is not defined in SYCL. This is a
            hardware-specific feature. Consult with your hardware vendor to find
            a replacement.
            */
            if (group<8>::laneid() == 0 && args.iter < 24)
...
#ifdef KITTENS_TIMINGS
            /*
            DPCT1008:348: clock64 function is not defined in SYCL. This is a
            hardware-specific feature. Consult with your hardware vendor to find
            a replacement.
            */
...
#ifdef KITTENS_TIMINGS
            /*
            DPCT1008:349: clock64 function is not defined in SYCL. This is a
            hardware-specific feature. Consult with your hardware vendor to find
            a replacement.
            */
            else if (group<8>::laneid() == 32) args.timings[63] = clock64();
