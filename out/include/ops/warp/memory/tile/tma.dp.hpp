...
inline sycl::int4 tma_coords(const coord<ducks::default_type> &unit_coord) {
...
static inline void prefetch(ST &dst, const GL &src, const COORD &idx) {
    if (::kittens::laneid()) {
 ...
 */
template<int axis, cache_policy policy, ducks::st::all ST, ducks::gl::all GL, ducks::coord::tile COORD=coord<ST>>
static inline void store_async(const GL &dst, const ST &src, const COORD &idx) {
    if (::kittens::laneid() == 0) {
...
static inline void store_async(const PGL &dst, const ST &src, const COORD &idx, const int dev_idx) {
    if (::kittens::laneid() == 0) {
 ...
 */
template<int axis, cache_policy policy, ducks::st::all ST, ducks::gl::all GL, ducks::coord::tile COORD=coord<ST>>
static inline void store_add_async(const GL &dst, const ST &src, const COORD &idx) {
...
template<int axis, cache_policy policy, ducks::st::all ST, ducks::pgl::all PGL, ducks::coord::tile COORD=coord<ST>>
static inline void store_add_async(const PGL &dst, const ST &src, const COORD &idx, const int dev_idx) {
 ...
 */
template<int axis, cache_policy policy, ducks::st::all ST, ducks::gl::all GL, ducks::coord::tile COORD=coord<ST>>
static inline void store_min_async(const GL &dst, const ST &src, const COORD &idx) {
...
template<int axis, cache_policy policy, ducks::st::all ST, ducks::pgl::all PGL, ducks::coord::tile COORD=coord<ST>>
static inline void store_min_async(const PGL &dst, const ST &src, const COORD &idx, const int dev_idx) {
    static_assert(!std::is_same_v<typename ST::dtype, float>, "TMA does not support async min/max reductions for fp32 types.");
 ...
 */
template<int axis, cache_policy policy, ducks::st::all ST, ducks::gl::all GL, ducks::coord::tile COORD=coord<ST>>
static inline void store_max_async(const GL &dst, const ST &src, const COORD &idx) {
    static_assert(!std::is_same_v<typename ST::dtype, float>, "TMA does not support async min/max reductions for fp32 types.");
...
template<int axis, cache_policy policy, ducks::st::all ST, ducks::pgl::all PGL, ducks::coord::tile COORD=coord<ST>>
static inline void store_max_async(const PGL &dst, const ST &src, const COORD &idx, const int dev_idx) {
    static_assert(!std::is_same_v<typename ST::dtype, float>, "TMA does not support async min/max reductions for fp32 types.");
