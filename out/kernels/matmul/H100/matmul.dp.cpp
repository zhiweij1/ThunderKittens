...
void inner_run(bf16 *d_A, bf16 *d_B, bf16 *d_C, size_t M, size_t N, size_t K,
    ...
    globals G{Ag, Bg, Cg};
    /*
    DPCT1049:393: The work-group size passed to the SYCL kernel may exceed the
...
int run_benchmark(size_t M, size_t N, size_t K) {
    ...
    /*
    DPCT1010:570: SYCL uses exceptions to report errors and does not use the
    error codes. The cudaGetLastError function call was replaced with 0. You
    need to rewrite this code.
    */
    cudaStatus = 0;
    /*
    DPCT1000:567: Error handling if-stmt was detected but could not be
    rewritten.
    */
    if (cudaStatus != 0) {
        /*
        DPCT1009:571: SYCL reports errors using exceptions and does not use
        error codes. Please replace the "get_error_string_dummy(...)" with a
        real error-handling function.
        */
        /*
        DPCT1001:566: The statement could not be removed.
        */
    ...
    // Check for CUDA errors
    /*
    DPCT1010:572: SYCL uses exceptions to report errors and does not use the
    error codes. The cudaGetLastError function call was replaced with 0. You
    need to rewrite this code.
    */
    cudaStatus = 0;
    /*
    DPCT1000:569: Error handling if-stmt was detected but could not be
    rewritten.
    */
    if (cudaStatus != 0) {
        /*
        DPCT1009:573: SYCL reports errors using exceptions and does not use
        error codes. Please replace the "get_error_string_dummy(...)" with a
        real error-handling function.
        */
        /*
        DPCT1001:568: The statement could not be removed.
        */
        std::cerr << "CUDA error: " << dpct::get_error_string_dummy(cudaStatus)
                  << std::endl;
        // Optionally, you might want to exit the program or handle the error in some way
